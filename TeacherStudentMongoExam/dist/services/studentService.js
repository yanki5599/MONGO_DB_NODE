...
const create = (newStudent) => __awaiter(void 0, void 0, void 0, function* () {
    const addedUser = yield userService.createUser(newStudent);
    try {
        newStudent.userId = addedUser._id;
        newStudent.role = role_js_1.Role.STUDENT;
        const added = yield student_js_1.default.create(newStudent);
        return added.populate("userId");
    }
    catch (error) {
